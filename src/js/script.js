...
const imagesText = [
  ...
  "Além dos protagonistas Joel e Ellie, a série apresenta uma variedade de personagens complexos e interessantes. Entre eles estão Tess (a esquerda), a parceira de Joel em missões anteriores, Marlene, líder dos Vaga-Lumes, um grupo de resistência contra a opressão do governo, e Bill, um sobrevivente solitário que vive em uma cidade abandonada.",
